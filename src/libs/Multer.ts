...
export default class Multer {
        ...
        return this.multer(mimetype, {
            storage: _multer.diskStorage({
                destination: function (req, file, cb) {
                    cb(null, makeDist(uploadConfig.rootDist, req.user['id'], file.mimetype, mimetype))
                },
     ...
     * */
    private makeFileName(fileName: string, fileMimetype: string, mimetypes): string {
     ...
     * */
    private makeDist(rootFolder: string, user: string, fileMimetype: string, mimetypes): string {
